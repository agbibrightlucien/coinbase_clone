        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label htmlFor="password" className="block text-[14px] font-semibold text-cb-text">Password</label>
              <a href="#" className="text-[13px] font-semibold text-cb-blue hover:text-cb-blue-hover">Forgot password?</a>
            </div>
            <input
              id="password"
              name="password"
